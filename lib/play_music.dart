...
import 'package:music_recommendation_with_emotional_analysiss/art_work_image.dart';
import 'package:music_recommendation_with_emotional_analysiss/constants/strings.dart';
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  void initState() {
    ...
    spotify.tracks.get("7MXVkk9YMctZqd1Srtv4MB").then((track) async {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      IconButton(
                          onPressed: () {},
                          icon:
                              const Icon(Icons.loop, color: Colors.deepPurple)),
                    ],
                  )
                ],
              ))
